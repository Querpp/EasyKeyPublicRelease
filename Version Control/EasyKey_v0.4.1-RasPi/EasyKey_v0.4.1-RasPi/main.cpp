/*******************************************************
 * File:        EasyKey v0.5.0 - Raspberry Pi Edition
 *
 * Description:
 *  - Stable release for Raspberry Pi Lite (no hardware interface)
 *  - Features:
 *      • "Apply Changes" button
 *      • Filter effect added (1 of 6 total effects)
 *      • Optimized and cleaner codebase
 *      • Oscillator engine implemented
 *      • Viewable effect parameters
 *      • Fully functional on Raspberry Pi 3 with required libraries
 *
 * Authors:     Ethan Laptew, David Frost, Courtney Jones
 * Created:     2025-04-22
 * License:     Public Domain / No Rights Reserved (CC0)
 ********************************************************/
