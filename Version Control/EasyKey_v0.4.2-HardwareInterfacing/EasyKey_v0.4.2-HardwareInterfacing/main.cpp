/*******************************************************
 * File Name:    EasyKey v0.4.2-HardwareInterfacing
 *
 * Description:
 * - Buttons communicate via GPIO pull-up registers
 * - Correct dimensions for LCD menu display
 * - Hardware interface: knobs & buttons supported
 * - Inverted knob values for correct reading
 * - Potentiometers update parameters via ADC scanning
 *
 * Author:       Ethan Laptew, David Frost, Courtney Jones
 * Created:      2025-04-15
 * Version:      v0.4.2-HardwareInterfacing
...
int main()
{
    ...
    while(true)
    {
        ...
        gpioDelay(75000); // debounce / pacing delay
                          //------------------------------------------------------
...
// L E V E L  T H R E E --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
                ...
                if (choices[highlight].name == "    Saw")
                {
                    ...
                    playCurrentSample("OscillatorWaveform_9", 1.0);   // Play the sample
                }
